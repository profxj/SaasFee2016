...
\label{fig:dla_compare}       % Give a unique label
\end{figure}
...
% to insert the figure file.
% For example, with the graphicx style use
\includegraphics[scale=0.8]{Figures/kirkman97_fig3.pdf}
%
% If no graphics program available, insert a blank space i.e. use
...
% to insert the figure file.
% For example, with the graphicx style use
\includegraphics[scale=0.8]{Figures/kirkman97_fig5.pdf}
%
% If no graphics program available, insert a blank space i.e. use
%\picplace{5cm}{2cm} % Givethe correct figure height and width in cm
%
...
% to insert the figure file.
% For example, with the graphicx style use
\includegraphics[scale=0.8]{Figures/hui99_fig1.pdf}
%
% If no graphics program available, insert a blank space i.e. use
%\picplace{5cm}{2cm} % Givethe correct figure height and width in cm
%
...
%%				\end{itemize}
%			\item Neverthelsess, we infer a greatly reduced EUVB
%				\begin{itemize}
...
Using \fnhi\ from \cite{pro+14}, %Prochaska+14
...
\includegraphics[scale=1.0]{Figures/fg08c_fig1.pdf}
%\includegraphics[width=4.5in]{Paper_figs/kirkman05_fig4.pdf}
%
% If no graphics program available, insert a blank space i.e. use
%\picplace{5cm}{2cm} % Givethe correct figure height and width in cm
...
\label{fig:Gamma}       % Give a unique label
\end{figure}
...
\label{fig:pow_fig10}       % Give a unique label
\end{figure}
...
\label{fig:rib11_fig6}       % Give a unique label
\end{figure}
...
\label{fig:r06_fig7}       % Give a unique label
\end{figure}
